  ...
  return (
    <header className={`${
      ...
      <div className='container mx-auto h-full flex items-center justify-between'>
        {/* logo */}
        <Link href=''>
          <Image src={'/assets/img/logo1.png'} width={117} height={55} alt='' />
        </Link>
        ...
        <Nav containerStyles='flex gap-4 text-white text-base uppercase 
        font-medium transition-all hidden sm:flex'/>
