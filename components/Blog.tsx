        ...
        <section className='bg-primary-300 text-white py-24' id='blog'>
           <div className="container mx-auto">
                ...
                {blogData.map((post, index) => {
                    ...
                    <SwiperSlide key={index}>
                        ...
                        <div className='flex flex-col items-start'>
                            <p className='max-w-[380px] uppercase text-[12px] tracking-[3px] mb-1 text-gray-300'>
                            {post.date}
                            </p>
                            <Link 
                            ...
                            href={post.href}
                            >
                            <h5 className='h5 line-clamp-2'>{post.title}</h5>
                            </Link>
                        </div>
                        </motion.div>
                    </SwiperSlide>
                ...
                <SwiperNavButtons
                    ...
                    btnStyles='bg-accent text-white w-[56px] h-[56px] flex justify-center items-center hover:bg-accent-dark transition-all duration-300'
                    iconStyles='text-2xl'
                />
                </Swiper>
                </motion.div>
